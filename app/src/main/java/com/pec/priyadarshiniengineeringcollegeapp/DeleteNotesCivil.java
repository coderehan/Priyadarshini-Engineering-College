...
public class DeleteNotesCivil extends AppCompatActivity {
    ActionBar actionBar;
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem1.setLayoutManager(new LinearLayoutManager(DeleteNotesCivil.this));
                    adapterNotes=new AdapterNotes(DeleteNotesCivil.this, list1);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem2.setLayoutManager(new LinearLayoutManager(DeleteNotesCivil.this));
                    adapterNotes=new AdapterNotes(DeleteNotesCivil.this, list2);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem3.setLayoutManager(new LinearLayoutManager(DeleteNotesCivil.this));
                    adapterNotes=new AdapterNotes(DeleteNotesCivil.this, list3);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem4.setLayoutManager(new LinearLayoutManager(DeleteNotesCivil.this));
                    adapterNotes=new AdapterNotes(DeleteNotesCivil.this, list4);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem5.setLayoutManager(new LinearLayoutManager(DeleteNotesCivil.this));
                    adapterNotes=new AdapterNotes(DeleteNotesCivil.this, list5);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem6.setLayoutManager(new LinearLayoutManager(DeleteNotesCivil.this));
                    adapterNotes=new AdapterNotes(DeleteNotesCivil.this, list6);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem7.setLayoutManager(new LinearLayoutManager(DeleteNotesCivil.this));
                    adapterNotes=new AdapterNotes(DeleteNotesCivil.this, list7);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem8.setLayoutManager(new LinearLayoutManager(DeleteNotesCivil.this));
                    adapterNotes=new AdapterNotes(DeleteNotesCivil.this, list8);
