...
public class AdapterGalleryStudentSide extends RecyclerView.Adapter<AdapterGalleryStudentSide.ViewHolder> {

    Context context;
    List<String> list;

    public AdapterGalleryStudentSide(Context context, List<String> list) {
