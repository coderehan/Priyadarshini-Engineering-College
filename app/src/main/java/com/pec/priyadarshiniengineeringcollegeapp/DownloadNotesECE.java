...
public class DownloadNotesECE extends AppCompatActivity {
    ActionBar actionBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_notes_e_c_e);

        actionBar=getSupportActionBar();
        actionBar.setTitle("ECE Dept");
    ...
    private void sem1() {
        ...
        dbRef1=databaseReference.child("ECE");
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem1.setLayoutManager(new LinearLayoutManager(DownloadNotesECE.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesECE.this, list1);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem2.setLayoutManager(new LinearLayoutManager(DownloadNotesECE.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesECE.this, list2);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem3.setLayoutManager(new LinearLayoutManager(DownloadNotesECE.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesECE.this, list3);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem4.setLayoutManager(new LinearLayoutManager(DownloadNotesECE.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesECE.this, list4);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem5.setLayoutManager(new LinearLayoutManager(DownloadNotesECE.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesECE.this, list5);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem6.setLayoutManager(new LinearLayoutManager(DownloadNotesECE.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesECE.this, list6);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem7.setLayoutManager(new LinearLayoutManager(DownloadNotesECE.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesECE.this, list7);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem8.setLayoutManager(new LinearLayoutManager(DownloadNotesECE.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesECE.this, list8);
