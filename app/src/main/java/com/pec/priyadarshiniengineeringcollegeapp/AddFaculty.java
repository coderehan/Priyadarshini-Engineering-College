...
ActionBar actionBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Add Faculty");
        ...
        uploadTask.addOnCompleteListener(AddFaculty.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                ...
                else
                {
                    ...
                    Toast.makeText(AddFaculty.this, "Something went wrong", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void uploadData() {
        ...
        ModalFaculty modalFaculty=new ModalFaculty(downloadUrl, name, designation, dept, unique_key);

        dbRef.child(unique_key).setValue(modalFaculty)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        progressDialog.dismiss();
                        Toast.makeText(AddFaculty.this, "Data added successfully", Toast.LENGTH_LONG).show();
