...
public class Faculty extends AppCompatActivity {
    ...
    AdapterFacultyStudentSide adapterFacultyStudentSide;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("PEC Faculty");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    cse.setLayoutManager(new LinearLayoutManager(Faculty.this));
                    adapterFacultyStudentSide=new AdapterFacultyStudentSide(Faculty.this, list1);
                    cse.setAdapter(adapterFacultyStudentSide);
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    ece.setLayoutManager(new LinearLayoutManager(Faculty.this));
                    adapterFacultyStudentSide=new AdapterFacultyStudentSide(Faculty.this, list2);
                    ece.setAdapter(adapterFacultyStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    eee.setLayoutManager(new LinearLayoutManager(Faculty.this));
                    adapterFacultyStudentSide=new AdapterFacultyStudentSide(Faculty.this, list3);
                    eee.setAdapter(adapterFacultyStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    civil.setLayoutManager(new LinearLayoutManager(Faculty.this));
                    adapterFacultyStudentSide=new AdapterFacultyStudentSide(Faculty.this, list4);
                    civil.setAdapter(adapterFacultyStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    mechanical.setLayoutManager(new LinearLayoutManager(Faculty.this));
                    adapterFacultyStudentSide=new AdapterFacultyStudentSide(Faculty.this, list5);
                    mechanical.setAdapter(adapterFacultyStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    mba.setLayoutManager(new LinearLayoutManager(Faculty.this));
                    adapterFacultyStudentSide=new AdapterFacultyStudentSide(Faculty.this, list6);
                    mba.setAdapter(adapterFacultyStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    mca.setLayoutManager(new LinearLayoutManager(Faculty.this));
                    adapterFacultyStudentSide=new AdapterFacultyStudentSide(Faculty.this, list7);
                    mca.setAdapter(adapterFacultyStudentSide);
                    progressDialog.dismiss();
                }
            }
