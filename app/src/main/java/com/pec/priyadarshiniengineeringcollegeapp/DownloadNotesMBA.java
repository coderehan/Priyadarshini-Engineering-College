...
public class DownloadNotesMBA extends AppCompatActivity {
    ActionBar actionBar;
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem1.setLayoutManager(new LinearLayoutManager(DownloadNotesMBA.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesMBA.this, list1);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem2.setLayoutManager(new LinearLayoutManager(DownloadNotesMBA.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesMBA.this, list2);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem3.setLayoutManager(new LinearLayoutManager(DownloadNotesMBA.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesMBA.this, list3);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem4.setLayoutManager(new LinearLayoutManager(DownloadNotesMBA.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesMBA.this, list4);
