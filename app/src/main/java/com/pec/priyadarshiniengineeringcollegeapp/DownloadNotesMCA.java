...
public class DownloadNotesMCA extends AppCompatActivity {
    ActionBar actionBar;
    ...
    private void sem1() {
        ...
        dbRef1=databaseReference.child("MCA");
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem1.setLayoutManager(new LinearLayoutManager(DownloadNotesMCA.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesMCA.this, list1);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem2.setLayoutManager(new LinearLayoutManager(DownloadNotesMCA.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesMCA.this, list2);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem3.setLayoutManager(new LinearLayoutManager(DownloadNotesMCA.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesMCA.this, list3);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem4.setLayoutManager(new LinearLayoutManager(DownloadNotesMCA.this));
                    adapterNotesStudentSide=new AdapterNotesStudentSide(DownloadNotesMCA.this, list4);
