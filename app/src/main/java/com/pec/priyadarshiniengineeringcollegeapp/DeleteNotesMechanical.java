...
public class DeleteNotesMechanical extends AppCompatActivity {
    ActionBar actionBar;
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem1.setLayoutManager(new LinearLayoutManager(DeleteNotesMechanical.this));
                    adapterNotes=new AdapterNotes(DeleteNotesMechanical.this, list1);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem2.setLayoutManager(new LinearLayoutManager(DeleteNotesMechanical.this));
                    adapterNotes=new AdapterNotes(DeleteNotesMechanical.this, list2);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem3.setLayoutManager(new LinearLayoutManager(DeleteNotesMechanical.this));
                    adapterNotes=new AdapterNotes(DeleteNotesMechanical.this, list3);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem4.setLayoutManager(new LinearLayoutManager(DeleteNotesMechanical.this));
                    adapterNotes=new AdapterNotes(DeleteNotesMechanical.this, list4);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem5.setLayoutManager(new LinearLayoutManager(DeleteNotesMechanical.this));
                    adapterNotes=new AdapterNotes(DeleteNotesMechanical.this, list5);
                    sem5.setAdapter(adapterNotes);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem6.setLayoutManager(new LinearLayoutManager(DeleteNotesMechanical.this));
                    adapterNotes=new AdapterNotes(DeleteNotesMechanical.this, list6);
                    sem6.setAdapter(adapterNotes);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem7.setLayoutManager(new LinearLayoutManager(DeleteNotesMechanical.this));
                    adapterNotes=new AdapterNotes(DeleteNotesMechanical.this, list7);
                    sem7.setAdapter(adapterNotes);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem8.setLayoutManager(new LinearLayoutManager(DeleteNotesMechanical.this));
                    adapterNotes=new AdapterNotes(DeleteNotesMechanical.this, list8);
                    sem8.setAdapter(adapterNotes);
                    progressDialog.dismiss();
                }
            }
