...
public class Gallery extends AppCompatActivity {
    ...
    AdapterGalleryStudentSide adapterGalleryStudentSide;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("PEC Gallery");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    graduation.setLayoutManager(new GridLayoutManager(Gallery.this, 3));
                    adapterGalleryStudentSide=new AdapterGalleryStudentSide(Gallery.this, list_graduation);
                    graduation.setAdapter(adapterGalleryStudentSide);
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    induction.setLayoutManager(new GridLayoutManager(Gallery.this, 3));
                    adapterGalleryStudentSide=new AdapterGalleryStudentSide(Gallery.this, list_induction);
                    induction.setAdapter(adapterGalleryStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    cse.setLayoutManager(new GridLayoutManager(Gallery.this, 3));
                    adapterGalleryStudentSide=new AdapterGalleryStudentSide(Gallery.this, list1);
                    cse.setAdapter(adapterGalleryStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    ece.setLayoutManager(new GridLayoutManager(Gallery.this, 3));
                    adapterGalleryStudentSide=new AdapterGalleryStudentSide(Gallery.this, list3);
                    ece.setAdapter(adapterGalleryStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    eee.setLayoutManager(new GridLayoutManager(Gallery.this, 3));
                    adapterGalleryStudentSide=new AdapterGalleryStudentSide(Gallery.this, list3);
                    eee.setAdapter(adapterGalleryStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    civil.setLayoutManager(new GridLayoutManager(Gallery.this, 3));
                    adapterGalleryStudentSide=new AdapterGalleryStudentSide(Gallery.this, list4);
                    civil.setAdapter(adapterGalleryStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    mechanical.setLayoutManager(new GridLayoutManager(Gallery.this, 3));
                    adapterGalleryStudentSide=new AdapterGalleryStudentSide(Gallery.this, list5);
                    mechanical.setAdapter(adapterGalleryStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    mba.setLayoutManager(new GridLayoutManager(Gallery.this, 3));
                    adapterGalleryStudentSide=new AdapterGalleryStudentSide(Gallery.this, list6);
                    mba.setAdapter(adapterGalleryStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    mca.setLayoutManager(new GridLayoutManager(Gallery.this, 3));
                    adapterGalleryStudentSide=new AdapterGalleryStudentSide(Gallery.this, list7);
                    mca.setAdapter(adapterGalleryStudentSide);
                    progressDialog.dismiss();
                }
            }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    adapterGalleryStudentSide=new AdapterGalleryStudentSide(Gallery.this, list_other);
                    other.setAdapter(adapterGalleryStudentSide);
                    progressDialog.dismiss();
                }
            }
