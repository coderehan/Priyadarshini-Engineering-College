...
public class UpdatePrincipal extends AppCompatActivity {
    ActionBar actionBar;
    CardView cardView;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_principal);

        actionBar=getSupportActionBar();
        actionBar.setTitle("Update Principal");
    ...
    private void uploadImage() {
        ...
        uploadTask.addOnCompleteListener(UpdatePrincipal.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                ...
                else
                {
                    ...
                    Toast.makeText(UpdatePrincipal.this, "Something went wrong", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        databaseReference.child(unique_key).updateChildren(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        progressDialog.dismiss();
                        Toast.makeText(UpdatePrincipal.this, "Data updated successfully", Toast.LENGTH_LONG).show();
                        Intent intent=new Intent(UpdatePrincipal.this, ManagePrincipal.class);
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(UpdatePrincipal.this, "Failed to update data", Toast.LENGTH_LONG).show();
            }
        });
