...
public class DeleteNotesECE extends AppCompatActivity {
    ActionBar actionBar;
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem1.setLayoutManager(new LinearLayoutManager(DeleteNotesECE.this));
                    adapterNotes=new AdapterNotes(DeleteNotesECE.this, list1);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem2.setLayoutManager(new LinearLayoutManager(DeleteNotesECE.this));
                    adapterNotes=new AdapterNotes(DeleteNotesECE.this, list2);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem3.setLayoutManager(new LinearLayoutManager(DeleteNotesECE.this));
                    adapterNotes=new AdapterNotes(DeleteNotesECE.this, list3);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem4.setLayoutManager(new LinearLayoutManager(DeleteNotesECE.this));
                    adapterNotes=new AdapterNotes(DeleteNotesECE.this, list4);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem5.setLayoutManager(new LinearLayoutManager(DeleteNotesECE.this));
                    adapterNotes=new AdapterNotes(DeleteNotesECE.this, list5);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem6.setLayoutManager(new LinearLayoutManager(DeleteNotesECE.this));
                    adapterNotes=new AdapterNotes(DeleteNotesECE.this, list6);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem7.setLayoutManager(new LinearLayoutManager(DeleteNotesECE.this));
                    adapterNotes=new AdapterNotes(DeleteNotesECE.this, list7);
        ...
        dbRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else
                {
                    ...
                    sem8.setLayoutManager(new LinearLayoutManager(DeleteNotesECE.this));
                    adapterNotes=new AdapterNotes(DeleteNotesECE.this, list8);
